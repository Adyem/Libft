...
class api_promise : public ft_promise<json_group*>
{
    public:
        ...
        api_promise(const api_promise &other) noexcept;
        api_promise(api_promise &&other) noexcept;
        ~api_promise() noexcept;
...
class api_string_promise : public ft_promise<char*>
{
    public:
        ...
        api_string_promise(const api_string_promise &other) noexcept;
        api_string_promise(api_string_promise &&other) noexcept;
        ~api_string_promise() noexcept;
...
class api_tls_promise : public ft_promise<json_group*>
{
    public:
        ...
        api_tls_promise(const api_tls_promise &other) noexcept;
        api_tls_promise(api_tls_promise &&other) noexcept;
        ~api_tls_promise() noexcept;
...
class api_tls_string_promise : public ft_promise<char*>
{
    public:
        ...
        api_tls_string_promise(const api_tls_string_promise &other) noexcept;
        api_tls_string_promise(api_tls_string_promise &&other) noexcept;
        ~api_tls_string_promise() noexcept;
