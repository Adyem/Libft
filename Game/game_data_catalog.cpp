...
ft_item_definition::ft_item_definition() noexcept
    : _item_id(0), _rarity(0), _max_stack(0), _width(0), _height(0), _weight(0), _slot_requirement(0), _error_code(ER_SUCCESS), _mutex()
{
...
ft_item_definition::ft_item_definition(int item_id, int rarity, int max_stack, int width, int height, int weight, int slot_requirement) noexcept
    : _item_id(item_id), _rarity(rarity), _max_stack(max_stack), _width(width), _height(height), _weight(weight), _slot_requirement(slot_requirement), _error_code(ER_SUCCESS), _mutex()
{
    this->set_error(ER_SUCCESS);
    return ;
}
...
ft_recipe_blueprint::ft_recipe_blueprint() noexcept
    : _recipe_id(0), _result_item_id(0), _ingredients(), _error_code(ER_SUCCESS), _mutex()
{
    this->set_error(ER_SUCCESS);
    return ;
}
...
ft_recipe_blueprint::ft_recipe_blueprint(int recipe_id, int result_item_id, const ft_vector<ft_crafting_ingredient> &ingredients) noexcept
    : _recipe_id(recipe_id), _result_item_id(result_item_id), _ingredients(), _error_code(ER_SUCCESS), _mutex()
{
...
ft_recipe_blueprint::ft_recipe_blueprint(ft_recipe_blueprint &&other) noexcept
    : _recipe_id(0), _result_item_id(0), _ingredients(ft_move(other._ingredients)), _error_code(ER_SUCCESS), _mutex()
{
    int entry_errno;
...
ft_loadout_entry::ft_loadout_entry() noexcept
    : _slot(0), _item_id(0), _quantity(0), _error_code(ER_SUCCESS), _mutex()
{
    this->set_error(ER_SUCCESS);
    return ;
}
...
ft_loadout_entry::ft_loadout_entry(int slot, int item_id, int quantity) noexcept
    : _slot(slot), _item_id(item_id), _quantity(quantity), _error_code(ER_SUCCESS), _mutex()
{
    this->set_error(ER_SUCCESS);
    return ;
}
...
ft_loadout_blueprint::ft_loadout_blueprint() noexcept
    : _loadout_id(0), _entries(), _error_code(ER_SUCCESS), _mutex()
{
    this->set_error(ER_SUCCESS);
    return ;
}
...
ft_loadout_blueprint::ft_loadout_blueprint(int loadout_id, const ft_vector<ft_loadout_entry> &entries) noexcept
    : _loadout_id(loadout_id), _entries(), _error_code(ER_SUCCESS), _mutex()
{
...
ft_loadout_blueprint::ft_loadout_blueprint(ft_loadout_blueprint &&other) noexcept
    : _loadout_id(0), _entries(ft_move(other._entries)), _error_code(ER_SUCCESS), _mutex()
{
    int entry_errno;
...
ft_data_catalog::ft_data_catalog() noexcept
    : _item_definitions(), _recipes(), _loadouts(), _error_code(ER_SUCCESS), _mutex()
{
    this->set_error(ER_SUCCESS);
    return ;
}
...
int ft_data_catalog::register_item_definition(const ft_item_definition &definition) noexcept
{
    ...
    if (this->_item_definitions.get_error() != ER_SUCCESS)
    {
...
int ft_data_catalog::register_recipe(const ft_recipe_blueprint &recipe) noexcept
{
    ...
    if (recipe.get_error() != ER_SUCCESS)
    {
...
int ft_data_catalog::register_loadout(const ft_loadout_blueprint &loadout) noexcept
{
    ...
    if (loadout.get_error() != ER_SUCCESS)
    {
    ...
    if (this->_loadouts.get_error() != ER_SUCCESS)
    {
