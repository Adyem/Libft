...
{
    ft_bool operator()(const ft_sharedptr<ft_event> &left, const ft_sharedptr<ft_event> &right) const noexcept;
};
...
class ft_event_scheduler
{
    ...
    public:
        ...
        int32_t move(ft_event_scheduler &other) noexcept;
        ...
        void update_events(ft_sharedptr<ft_world> &world, int32_t ticks, const char *log_file_path = ft_nullptr, ft_string *log_buffer = ft_nullptr) noexcept;
