...
FT_TEST(test_game_buff_invalid_duration_preserves_errno,
        "ft_buff rejects negative duration without altering errno")
{
    ft_buff buff;
    int entry_errno;
    int duration_value;
...
FT_TEST(test_game_debuff_invalid_duration_preserves_errno,
        "ft_debuff rejects negative duration without altering errno")
{
    ft_debuff debuff;
    int entry_errno;
    int duration_value;
...
FT_TEST(test_game_skill_invalid_cooldown_preserves_errno,
        "ft_skill rejects subtracting excessive cooldown without altering errno")
{
    ft_skill skill;
    int entry_errno;
    int cooldown_value;
...
FT_TEST(test_game_equipment_invalid_slot_preserves_errno,
        "ft_equipment rejects unknown slot assignments without altering errno")
{
    ...
    FT_ASSERT(ft_errno == entry_errno || ft_errno == ER_SUCCESS);
    return (1);
}

FT_TEST(test_game_equipment_invalid_item_preserves_errno,
        "ft_equipment rejects null items without altering errno")
{
    ft_equipment equipment;
    ft_sharedptr<ft_item> item;
    int entry_errno;
