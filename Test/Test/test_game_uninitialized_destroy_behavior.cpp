...
FT_TEST(test_game_price_definition_destroy_uninitialised_returns_invalid_state,
    "ft_price_definition destroy on uninitialised object is non-aborting")
{
    ...
    FT_ASSERT_EQ(1, expect_no_sigabrt_on_uninitialised_destructor<ft_price_definition>());
    return (1);
}

FT_TEST(test_game_rarity_band_destroy_uninitialised_returns_invalid_state,
    "ft_rarity_band destroy on uninitialised object is non-aborting")
{
    ft_rarity_band band;

    FT_ASSERT_EQ(FT_ERR_INVALID_STATE, band.destroy());
    FT_ASSERT_EQ(FT_ERR_INVALID_STATE, band.get_error());
    FT_ASSERT_EQ(1, expect_no_sigabrt_on_uninitialised_destructor<ft_rarity_band>());
    return (1);
}

FT_TEST(test_game_vendor_profile_destroy_uninitialised_returns_invalid_state,
    "ft_vendor_profile destroy on uninitialised object is non-aborting")
{
    ...
    "ft_reputation destroy on uninitialised object is non-aborting")
{
    ...
    FT_ASSERT_EQ(1, expect_no_sigabrt_on_uninitialised_destructor<ft_reputation>());
    return (1);
}

FT_TEST(test_game_dialogue_script_destroy_uninitialised_returns_invalid_state,
    "ft_dialogue_script destroy on uninitialised object is non-aborting")
{
    ...
    FT_ASSERT_EQ(1, expect_no_sigabrt_on_uninitialised_destructor<ft_dialogue_script>());
    return (1);
}

FT_TEST(test_game_progress_tracker_destroy_uninitialised_returns_invalid_state,
    "ft_progress_tracker destroy on uninitialised object is non-aborting")
{
    ...
    FT_ASSERT_EQ(1, expect_no_sigabrt_on_uninitialised_destructor<ft_progress_tracker>());
    return (1);
}

FT_TEST(test_game_inventory_destroy_uninitialised_returns_invalid_state,
    "ft_inventory destroy on uninitialised object is non-aborting")
{
    ...
    FT_ASSERT_EQ(1, expect_no_sigabrt_on_uninitialised_destructor<ft_inventory>());
    return (1);
}

FT_TEST(test_game_map3d_destroy_uninitialised_returns_invalid_state,
    "ft_map3d destroy on uninitialised object is non-aborting")
{
    ...
    FT_ASSERT_EQ(1, expect_no_sigabrt_on_uninitialised_destructor<ft_map3d>());
    return (1);
}

FT_TEST(test_game_achievement_destroy_uninitialised_returns_invalid_state,
    "ft_achievement destroy on uninitialised object is non-aborting")
{
    ...
    FT_ASSERT_EQ(1, expect_no_sigabrt_on_uninitialised_destructor<ft_achievement>());
    return (1);
}

FT_TEST(test_game_hooks_destroy_uninitialised_returns_invalid_state,
    "ft_game_hooks destroy on uninitialised object is non-aborting")
{
    ft_game_hooks hooks;

    FT_ASSERT_EQ(FT_ERR_INVALID_STATE, hooks.destroy());
    FT_ASSERT_EQ(FT_ERR_INVALID_STATE, hooks.get_error());
    FT_ASSERT_EQ(1, expect_no_sigabrt_on_uninitialised_destructor<ft_game_hooks>());
    return (1);
}

FT_TEST(test_game_goal_destroy_uninitialised_returns_invalid_state,
    "ft_goal destroy on uninitialised object is non-aborting")
{
    ft_goal goal;

    FT_ASSERT_EQ(FT_ERR_INVALID_STATE, goal.destroy());
    FT_ASSERT_EQ(FT_ERR_INVALID_STATE, goal.get_error());
    FT_ASSERT_EQ(1, expect_no_sigabrt_on_uninitialised_destructor<ft_goal>());
    return (1);
}

FT_TEST(test_game_item_definition_destroy_uninitialised_is_non_aborting,
    "ft_item_definition destroy on uninitialised object is non-aborting")
{
    ...
    FT_ASSERT_EQ(1,
        expect_no_sigabrt_on_uninitialised_destructor<ft_item_definition>());
    return (1);
}

FT_TEST(test_game_recipe_blueprint_destroy_uninitialised_is_non_aborting,
    "ft_recipe_blueprint destroy on uninitialised object is non-aborting")
{
    ...
    FT_ASSERT_EQ(1,
        expect_no_sigabrt_on_uninitialised_destructor<ft_recipe_blueprint>());
    return (1);
}

FT_TEST(test_game_loadout_entry_destroy_uninitialised_is_non_aborting,
    "ft_loadout_entry destroy on uninitialised object is non-aborting")
{
    ...
    FT_ASSERT_EQ(1,
        expect_no_sigabrt_on_uninitialised_destructor<ft_loadout_entry>());
    return (1);
}

FT_TEST(test_game_loadout_blueprint_destroy_uninitialised_is_non_aborting,
    "ft_loadout_blueprint destroy on uninitialised object is non-aborting")
{
    ...
    FT_ASSERT_EQ(1,
        expect_no_sigabrt_on_uninitialised_destructor<ft_loadout_blueprint>());
    return (1);
}

FT_TEST(test_game_data_catalog_destroy_uninitialised_is_non_aborting,
    "ft_data_catalog destroy on uninitialised object is non-aborting")
{
    ...
    FT_ASSERT_EQ(1, expect_no_sigabrt_on_uninitialised_destructor<ft_data_catalog>());
    return (1);
}

FT_TEST(test_game_dialogue_table_destroy_uninitialised_is_non_aborting,
    "ft_dialogue_table destroy on uninitialised object is non-aborting")
{
    ...
    FT_ASSERT_EQ(1,
        expect_no_sigabrt_on_uninitialised_destructor<ft_dialogue_table>());
    return (1);
}

FT_TEST(test_game_path_step_destroy_uninitialised_is_non_aborting,
    "ft_path_step destroy on uninitialised object is non-aborting")
{
    ...
    FT_ASSERT_EQ(1, expect_no_sigabrt_on_uninitialised_destructor<ft_path_step>());
    return (1);
}

FT_TEST(test_game_pathfinding_destroy_uninitialised_is_non_aborting,
    "ft_pathfinding destroy on uninitialised object is non-aborting")
{
    ...
    FT_ASSERT_EQ(1,
        expect_no_sigabrt_on_uninitialised_destructor<ft_pathfinding>());
    return (1);
}

FT_TEST(test_game_world_region_destroy_uninitialised_is_non_aborting,
    "ft_world_region destroy on uninitialised object is non-aborting")
{
    ...
    FT_ASSERT_EQ(1,
        expect_no_sigabrt_on_uninitialised_destructor<ft_world_region>());
    return (1);
}

FT_TEST(test_game_region_definition_destroy_uninitialised_is_non_aborting,
    "ft_region_definition destroy on uninitialised object is non-aborting")
{
    ...
    FT_ASSERT_EQ(1,
        expect_no_sigabrt_on_uninitialised_destructor<ft_region_definition>());
    return (1);
}

FT_TEST(test_game_world_registry_destroy_uninitialised_is_non_aborting,
    "ft_world_registry destroy on uninitialised object is non-aborting")
{
    ...
    FT_ASSERT_EQ(1,
        expect_no_sigabrt_on_uninitialised_destructor<ft_world_registry>());
    return (1);
}

FT_TEST(test_game_event_scheduler_destroy_uninitialised_is_non_aborting,
    "ft_event_scheduler destroy on uninitialised object is non-aborting")
{
    ...
    FT_ASSERT_EQ(1,
        expect_no_sigabrt_on_uninitialised_destructor<ft_event_scheduler>());
    return (1);
}

FT_TEST(test_game_world_replay_destroy_uninitialised_is_non_aborting,
    "ft_world_replay_session destroy on uninitialised object is non-aborting")
{
...
FT_TEST(test_game_quest_destroy_uninitialised_is_non_aborting,
    "ft_quest destroy on uninitialised object is non-aborting")
{
    ft_quest quest;
    ...
    FT_ASSERT_EQ(1, expect_no_sigabrt_on_uninitialised_destructor<ft_quest>());
    return (1);
}

FT_TEST(test_game_upgrade_destroy_uninitialised_is_non_aborting,
    "ft_upgrade destroy on uninitialised object is non-aborting")
{
    ft_upgrade upgrade;
    ...
    FT_ASSERT_EQ(1, expect_no_sigabrt_on_uninitialised_destructor<ft_upgrade>());
    return (1);
}
