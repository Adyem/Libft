...
FT_TEST(test_math_pow_positive_exponent, "math_pow handles positive exponents")
{
    double result;
...
FT_TEST(test_math_pow_zero_base_negative_exponent, "math_pow rejects zero base with negative exponent")
{
    double result;
