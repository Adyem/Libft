...
FT_TEST(test_game_buff_rejects_negative_id)
{
    game_buff buff;
...
FT_TEST(test_game_buff_duration_addition_rejects_negative)
{
    game_buff buff;
    FT_ASSERT_EQ(FT_ERR_SUCCESS, buff.initialize());
...
FT_TEST(test_game_debuff_modifier_updates_apply_deltas)
{
    game_debuff debuff;
...
FT_TEST(test_game_resistance_reset_clears_values)
{
...
FT_TEST(test_game_resistance_set_values_copy_values)
{
