...
FT_TEST(test_compress_rejects_oversize_input)
{
...
FT_TEST(test_decompress_rejects_oversize_payload)
{
...
FT_TEST(test_ft_compress_round_trip)
{
...
FT_TEST(test_compression_stream_round_trip)
{
    const char      *input_string;
...
FT_TEST(test_base64_round_trip)
{
    const char      *input_string;
...
FT_TEST(test_base64_encode_null_terminator)
{
    const char      *input_string;
...
FT_TEST(test_base64_decode_ignores_whitespace)
{
    const char      *input_string;
...
FT_TEST(test_base64_decode_paddingless_tail)
{
    const char      *input_string;
    const char      *expected_output;
    unsigned char   *decoded_buffer;
...
FT_TEST(test_base64_invalid_character)
{
