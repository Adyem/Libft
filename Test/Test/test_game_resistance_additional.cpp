...
FT_TEST(test_game_resistance_default_initialization)
{
...
FT_TEST(test_game_resistance_set_percent_resets_errno)
{
    game_resistance resistance;
    FT_ASSERT_EQ(FT_ERR_SUCCESS, resistance.initialize());
...
FT_TEST(test_game_resistance_set_flat_resets_errno)
{
    game_resistance resistance;
    FT_ASSERT_EQ(FT_ERR_SUCCESS, resistance.initialize());
...
FT_TEST(test_game_resistance_set_values_updates_both)
{
    game_resistance resistance;
    FT_ASSERT_EQ(FT_ERR_SUCCESS, resistance.initialize());
...
FT_TEST(test_game_resistance_reset_clears_after_updates)
{
    game_resistance resistance;
    FT_ASSERT_EQ(FT_ERR_SUCCESS, resistance.initialize());
...
FT_TEST(test_game_resistance_get_percent_sets_errno_success)
{
    game_resistance resistance;
    FT_ASSERT_EQ(FT_ERR_SUCCESS, resistance.initialize());
...
FT_TEST(test_game_resistance_get_flat_sets_errno_success)
{
    game_resistance resistance;
    FT_ASSERT_EQ(FT_ERR_SUCCESS, resistance.initialize());
...
FT_TEST(test_game_resistance_get_error_sets_errno_success)
{
    game_resistance resistance;
    FT_ASSERT_EQ(FT_ERR_SUCCESS, resistance.initialize());
...
FT_TEST(test_game_resistance_get_error_str_reports_success)
{
    game_resistance resistance;
    FT_ASSERT_EQ(FT_ERR_SUCCESS, resistance.initialize());
...
FT_TEST(test_game_resistance_thread_safety_toggle)
{
    game_resistance resistance;
    FT_ASSERT_EQ(FT_ERR_SUCCESS, resistance.initialize());
