...
int test_ft_shared_ptr_basic(void)
{
    ...
    return (operations_ok && sp.get_error() == FT_ERR_SUCCESS);
}

int test_ft_unique_ptr_basic(void)
{
    ft_uniqueptr<int> up(new int(7));
    return (up.get_error() == FT_ERR_SUCCESS
            && *up == 7);
}
...
FT_TEST(test_ft_vector_erase_releases_resources)
{
...
int test_ft_shared_ptr_array(void)
{
    ...
    if (sp.get_error() != FT_ERR_SUCCESS)
        return (0);
    int &value0 = sp[0];
    value0 = 1;
    int &value1 = sp[1];
...
int test_ft_unique_ptr_array(void)
{
    ...
    if (up.get_error() != FT_ERR_SUCCESS)
        return (0);
    int &value0 = up[0];
    value0 = 1;
    int &value1 = up[1];
    ...
    int &value2 = up[2];
    value2 = 3;
    return (up[2] == 3 && up.get_error() == FT_ERR_SUCCESS);
}
...
FT_TEST(test_ft_vector_resets_errno_after_successful_push)
{
...
FT_TEST(test_ft_set_resets_errno_after_successful_insert)
{
...
FT_TEST(test_ft_stack_resets_errno_after_successful_push)
{
...
FT_TEST(test_ft_map_grows_from_zero_capacity)
{
