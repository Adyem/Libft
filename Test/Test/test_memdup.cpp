...
FT_TEST(test_memdup_zero_size, "cma_memdup zero size")
{
    char buffer[3];
...
FT_TEST(test_memdup_zero_size_null_source_allocates,
        "cma_memdup allocates even when size is zero and source is null")
{
    void *duplicate;
...
FT_TEST(test_memdup_independent_copy, "cma_memdup duplicates without sharing storage")
{
    char source[4];
...
FT_TEST(test_memdup_resets_errno_after_null_source,
        "cma_memdup clears errno after failure")
{
    void *duplicate;
...
FT_TEST(test_memdup_preserves_embedded_null_bytes,
        "cma_memdup copies buffers containing null bytes")
{
