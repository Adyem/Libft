...
FT_TEST(test_su_open_null_path_returns_negative)
{
    FT_ASSERT_EQ(-1, su_open(ft_nullptr));
    return (1);
}

FT_TEST(test_su_open_with_flags_null_path_returns_negative)
{
    FT_ASSERT_EQ(-1, su_open(ft_nullptr, O_RDONLY));
    return (1);
}

FT_TEST(test_su_open_with_mode_null_path_returns_negative)
{
...
FT_TEST(test_su_write_zero_count_returns_zero)
{
...
FT_TEST(test_su_fopen_null_path_returns_null)
{
    FT_ASSERT_EQ(ft_nullptr, su_fopen(ft_nullptr));
    return (1);
}

FT_TEST(test_su_fopen_flags_null_path_returns_null)
{
    FT_ASSERT_EQ(ft_nullptr, su_fopen(ft_nullptr, O_RDONLY));
    return (1);
}

FT_TEST(test_su_fopen_mode_null_path_returns_null)
{
    FT_ASSERT_EQ(ft_nullptr, su_fopen(ft_nullptr, O_RDONLY, 0644));
    return (1);
}

FT_TEST(test_su_fclose_null_stream_returns_negative)
{
    FT_ASSERT_EQ(-1, su_fclose(ft_nullptr));
    return (1);
}

FT_TEST(test_su_fread_null_buffer_returns_zero)
{
    FT_ASSERT_EQ(0, su_fread(ft_nullptr, 1, 1, ft_nullptr));
    return (1);
}

FT_TEST(test_su_fread_null_stream_returns_zero)
{
    char buffer_data[4];
...
FT_TEST(test_su_fwrite_null_buffer_returns_zero)
{
    FT_ASSERT_EQ(0, su_fwrite(ft_nullptr, 1, 1, ft_nullptr));
    return (1);
}

FT_TEST(test_su_fwrite_null_stream_returns_zero)
{
    char buffer_data[4];
...
FT_TEST(test_su_fseek_null_stream_returns_negative)
{
    FT_ASSERT_EQ(-1, su_fseek(ft_nullptr, 0, SEEK_SET));
    return (1);
}

FT_TEST(test_su_ftell_null_stream_returns_negative)
{
    FT_ASSERT_EQ(-1L, su_ftell(ft_nullptr));
    return (1);
}

FT_TEST(test_su_copy_file_null_source_returns_negative)
{
    FT_ASSERT_EQ(-1, su_copy_file(ft_nullptr, "target.txt"));
    return (1);
}

FT_TEST(test_su_copy_file_null_destination_returns_negative)
{
    FT_ASSERT_EQ(-1, su_copy_file("source.txt", ft_nullptr));
    return (1);
}

FT_TEST(test_su_copy_directory_null_source_returns_negative)
{
    FT_ASSERT_EQ(-1, su_copy_directory_recursive(ft_nullptr, "destination"));
    return (1);
}

FT_TEST(test_su_copy_directory_null_destination_returns_negative)
{
    FT_ASSERT_EQ(-1, su_copy_directory_recursive("source", ft_nullptr));
    return (1);
}

FT_TEST(test_su_inspect_permissions_null_path_returns_negative)
{
    mode_t permissions;
...
FT_TEST(test_su_inspect_permissions_null_output_returns_negative)
{
    FT_ASSERT_EQ(-1, su_inspect_permissions("any_path", ft_nullptr));
    return (1);
}

FT_TEST(test_su_chmod_null_path_returns_negative)
{
    FT_ASSERT_EQ(-1, su_chmod(ft_nullptr, 6, 4, 4));
    return (1);
}

FT_TEST(test_su_chmod_invalid_owner_permissions_returns_negative)
{
    FT_ASSERT_EQ(-1, su_chmod("any_path", -1, 4, 4));
    return (1);
}

FT_TEST(test_su_chmod_invalid_group_permissions_returns_negative)
{
    FT_ASSERT_EQ(-1, su_chmod("any_path", 6, 9, 4));
    return (1);
}

FT_TEST(test_su_chmod_invalid_other_permissions_returns_negative)
{
...
FT_TEST(test_su_chmod_valid_file_returns_zero)
{
    const char *path;
