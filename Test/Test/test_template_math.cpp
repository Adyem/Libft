...
FT_TEST(test_template_math_ft_max_basic)
{
    double mixed_result;
...
FT_TEST(test_template_math_ft_min_basic)
{
    double mixed_result;
...
FT_TEST(test_template_math_ft_max_with_comparator)
{
...
FT_TEST(test_template_math_ft_min_with_comparator)
{
...
FT_TEST(test_template_math_is_single_convertible_runtime)
{
