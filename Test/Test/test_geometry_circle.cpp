...
FT_TEST(test_intersect_circle_overlap, "intersect_circle detects overlapping circles")
{
    ...
    FT_ASSERT_EQ(FT_ERR_SUCCESS, first.set_center(0.0, 0.0));
    FT_ASSERT_EQ(FT_ERR_SUCCESS, first.set_radius(4.0));
    FT_ASSERT_EQ(FT_ERR_SUCCESS, second.set_center(3.0, 0.0));
    FT_ASSERT_EQ(FT_ERR_SUCCESS, second.set_radius(3.0));
...
FT_TEST(test_intersect_circle_separated, "intersect_circle returns false when distance exceeds radii")
{
    ...
    FT_ASSERT_EQ(FT_ERR_SUCCESS, first.set_center(-5.0, -5.0));
    FT_ASSERT_EQ(FT_ERR_SUCCESS, first.set_radius(2.0));
    FT_ASSERT_EQ(FT_ERR_SUCCESS, second.set_center(2.0, 2.0));
    FT_ASSERT_EQ(FT_ERR_SUCCESS, second.set_radius(1.5));
...
FT_TEST(test_intersect_circle_touching, "intersect_circle treats tangential contact as intersection")
{
    ...
    FT_ASSERT_EQ(FT_ERR_SUCCESS, first.set_center(0.0, 0.0));
    FT_ASSERT_EQ(FT_ERR_SUCCESS, first.set_radius(3.0));
    FT_ASSERT_EQ(FT_ERR_SUCCESS, second.set_center(4.0, 0.0));
...
FT_TEST(test_intersect_circle_parallel_access, "intersect_circle handles concurrent calls")
{
    ...
    FT_ASSERT_EQ(FT_ERR_SUCCESS, second.set_center(1.0, 1.0));
...
FT_TEST(test_intersect_circle_self_reference, "intersect_circle supports self collisions")
{
    ...
    FT_ASSERT_EQ(FT_ERR_SUCCESS, shape.set_center(2.0, -1.0));
    FT_ASSERT_EQ(FT_ERR_SUCCESS, shape.set_radius(3.5));
    ft_errno = FT_ERR_ALREADY_EXISTS;
...
FT_TEST(test_circle_move_constructor_resets_source, "circle move constructor transfers state")
{
    ...
    FT_ASSERT_EQ(FT_ERR_SUCCESS, source.set_center(-4.0, 5.0));
    FT_ASSERT_EQ(FT_ERR_SUCCESS, source.set_radius(6.0));
