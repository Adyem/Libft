...
static int assert_action_values(const game_behavior_action &action, int action_id, double weight,
        double cooldown)
{
...
FT_TEST(test_behavior_register_and_fetch)
{
...
FT_TEST(test_behavior_missing_profile)
{
    game_behavior_table table;
    game_behavior_profile profile;
...
FT_TEST(test_behavior_profile_isolation)
{
    game_behavior_table table;
    ft_vector<game_behavior_action> actions;
    game_behavior_profile profile;
    game_behavior_profile first_fetch;
