...
FT_TEST(test_game_behavior_restore_errno_unlocks_guard, "restore errno unlocks guard and propagates code")
{
    pt_mutex mutex;
...
FT_TEST(test_game_behavior_restore_errno_without_lock, "restore errno when guard does not own lock")
{
...
FT_TEST(test_game_behavior_sleep_backoff_preserves_errno, "sleep backoff does not modify errno")
{
