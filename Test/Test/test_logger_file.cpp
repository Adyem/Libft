...
FT_TEST(test_logger_set_file_missing_directory)
{
...
FT_TEST(test_logger_rotate_fstat_failure_sets_errno)
{
    s_file_sink sink;
...
FT_TEST(test_logger_rotate_rename_failure_reopens_file)
{
