...
FT_TEST(test_price_definition_setters_preserve_values)
{
...
FT_TEST(test_price_definition_initialize_copy_preserves_values)
{
...
FT_TEST(test_currency_rate_setters_preserve_values)
{
...
FT_TEST(test_currency_rate_initialize_copy_preserves_values)
{
...
FT_TEST(test_rarity_band_setters_preserve_values)
{
...
FT_TEST(test_rarity_band_initialize_copy_preserves_values)
{
    game_rarity_band source;
    game_rarity_band clone;
