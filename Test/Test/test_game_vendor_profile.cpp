...
FT_TEST(test_vendor_profile_initialize_values)
{
...
FT_TEST(test_vendor_profile_setters_update_fields)
{
    game_vendor_profile profile;
...
FT_TEST(test_vendor_profile_set_negative_id_reports_error)
{
    game_vendor_profile profile;
...
FT_TEST(test_vendor_profile_initialize_copy)
{
