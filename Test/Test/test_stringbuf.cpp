...
FT_TEST(test_ft_stringbuf_read_basic)
{
    ft_string source;
...
FT_TEST(test_ft_stringbuf_read_null_buffer_sets_error)
{
    ft_string source;
...
FT_TEST(test_ft_stringbuf_str_returns_remaining)
{
    ft_string source;
...
FT_TEST(test_ft_stringbuf_read_past_end_returns_zero)
{
    ft_string source;
