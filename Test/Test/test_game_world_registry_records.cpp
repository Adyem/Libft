...
FT_TEST(test_world_registry_register_and_fetch_records)
{
...
FT_TEST(test_world_registry_records_isolate_fetched_values)
{
    game_world_registry registry;
    ft_vector<int> region_ids;
    ...
    game_region_definition fetched_region;
    game_world_region fetched_world;
    game_region_definition re_fetched_region;
    game_world_region re_fetched_world;
...
FT_TEST(test_world_registry_records_handles_missing_entries)
{
    game_world_registry registry;
    game_region_definition region;
    game_world_region world;
