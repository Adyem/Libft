...
FT_TEST(test_game_region_definition_basic_accessors)
{
...
FT_TEST(test_game_region_definition_resize_fields)
{
    game_region_definition region;
...
FT_TEST(test_game_region_definition_initialize_copy)
{
