...
FT_TEST(test_time_fps_set_rejects_low_frame_rate)
{
    ...
    FT_ASSERT_EQ(static_cast<int64_t>(0), limiter.get_frames_per_second());
    return (1);
}
