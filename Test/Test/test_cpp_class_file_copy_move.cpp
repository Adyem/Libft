        ...
        "ft_file move constructor initializes an independent mutex")
{
    ...
    FT_ASSERT_EQ(ER_SUCCESS, create_pipe(&read_end, &write_end));
        ...
        "ft_file move assignment initializes an independent mutex")
{
    ...
    FT_ASSERT_EQ(ER_SUCCESS, create_pipe(&source_read_end, &source_write_end));
    FT_ASSERT_EQ(ER_SUCCESS, create_pipe(&target_read_end, &target_write_end));
