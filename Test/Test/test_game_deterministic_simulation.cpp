...
{
    ft_sharedptr<game_world> world_instance(new (std::nothrow) game_world());
    ...
    ft_sharedptr<game_item> oak_plank(new (std::nothrow) game_item());
    ...
    game_crafting crafting_system;

    game_crafting_ingredient oak_requirement;
    ...
    ft_sharedptr<game_item> crafted_sword(new (std::nothrow) game_item());
    ...
    ft_sharedptr<game_event> combat_event(new (std::nothrow) game_event());
    ...
    combat_event->set_callback(ft_function<void(game_world&, game_event&)>([&](game_world &world_reference, game_event &event_reference)
    {
        (void)world_reference;
    ...
    ft_sharedptr<game_event> completion_event(new (std::nothrow) game_event());
    ...
    completion_event->set_callback(ft_function<void(game_world&, game_event&)>([&](game_world &world_reference, game_event &event_reference)
    {
        (void)world_reference;
