    ...
    "Game deterministic simulation across combat, crafting, quests, and events")
{
    ...
    FT_ASSERT_EQ(hero_character.get_error(), FT_ERR_SUCCESS);
    FT_ASSERT_EQ(enemy_character.get_error(), FT_ERR_SUCCESS);

    ft_inventory hero_inventory(6);
    FT_ASSERT_EQ(hero_inventory.get_error(), FT_ERR_SUCCESS);
    ...
    FT_ASSERT_EQ(crafting_system.get_error(), FT_ERR_SUCCESS);
    ...
    FT_ASSERT_EQ(sword_recipe.get_error(), FT_ERR_SUCCESS);
    ...
    FT_ASSERT_EQ(crafting_quest.get_error(), FT_ERR_SUCCESS);
    hero_character.get_quests().insert(crafting_quest.get_id(), crafting_quest);
    FT_ASSERT_EQ(hero_character.get_quests().get_error(), FT_ERR_SUCCESS);
