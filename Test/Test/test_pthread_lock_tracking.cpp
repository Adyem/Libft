...
#define RECORD_ASSERT(expression) \
    ...
    RECORD_ASSERT(first_mutex.get_error() == FT_ER_SUCCESSS);
    ...
    RECORD_ASSERT(shared.first_lock_error.load() == FT_ER_SUCCESSS);
    ...
    RECORD_ASSERT(shared.second_lock_error.load() == FT_ER_SUCCESSS);
...
FT_TEST(test_pt_lock_tracking_reports_owned_mutexes, "pt_lock_tracking reports the mutexes owned by a thread")
{
    ...
    FT_ASSERT_EQ(FT_ER_SUCCESSS, first_mutex.get_error());
    FT_ASSERT_EQ(FT_SUCCESS, second_mutex.lock(THREAD_ID));
    FT_ASSERT_EQ(FT_ER_SUCCESSS, second_mutex.get_error());
...
#define RECORD_ASSERT(expression) \
    ...
    RECORD_ASSERT(mutex_object.get_error() == FT_ER_SUCCESSS);
...
#define RECORD_ASSERT(expression) \
    ...
    RECORD_ASSERT(shared_state.lock_error.load() == FT_ER_SUCCESSS);
    ...
    RECORD_ASSERT(shared_state.unlock_result.load() == FT_SUCCESS);
    RECORD_ASSERT(shared_state.unlock_error.load() == FT_ER_SUCCESSS);
    RECORD_ASSERT(mutex_object.lock(THREAD_ID) == FT_SUCCESS);
    RECORD_ASSERT(mutex_object.get_error() == FT_ER_SUCCESSS);
    RECORD_ASSERT(mutex_object.lockState());
    RECORD_ASSERT(mutex_object.unlock(THREAD_ID) == FT_SUCCESS);
...
#define RECORD_ASSERT(expression) \
    ...
    RECORD_ASSERT(ft_errno == FT_ER_SUCCESSS);
