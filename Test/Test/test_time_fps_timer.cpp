...
FT_TEST(test_time_fps_get_frames_sets_errno_success)
{
    ...
    FT_ASSERT_EQ(static_cast<int64_t>(30), value);
    return (1);
}
...
FT_TEST(test_time_fps_invalid_configuration_reports_error)
{
    ...
    FT_ASSERT_EQ(static_cast<int64_t>(0), frames_per_second.get_frames_per_second());
    return (1);
}
...
FT_TEST(test_time_timer_zero_duration_finishes_immediately)
{
    ...
    FT_ASSERT_EQ(static_cast<int64_t>(0), remaining);
    return (1);
}
...
FT_TEST(test_time_timer_add_time_requires_running_timer)
{
    ...
    FT_ASSERT_EQ(static_cast<int64_t>(-1), result);
    return (1);
}
