        ...
        "ft_vector move constructor recreates mutex and moves elements")
{
    ...
    FT_ASSERT_EQ(0, source_vector.enable_thread_safety());
    ...
    FT_ASSERT_EQ(false, source_vector.is_thread_safe());
        ...
        "ft_vector move assignment recreates mutex and replaces contents")
{
    ...
    FT_ASSERT_EQ(0, destination_vector.enable_thread_safety());
