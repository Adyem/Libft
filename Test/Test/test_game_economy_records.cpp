...
static int assert_price_values(const game_price_definition &definition, int item_id, int rarity,
...
static int assert_rarity_values(const game_rarity_band &band, int rarity,
        double multiplier)
{
...
static int assert_rate_values(const game_currency_rate &rate, int currency_id,
...
FT_TEST(test_price_definition_setters_overwrite_fields)
{
...
FT_TEST(test_currency_rate_initialize_copy_matches_source)
{
