...
FT_TEST(test_big_number_errno_resets_construction_and_assignment)
{
    {
...
FT_TEST(test_big_number_errno_resets_mutators)
{
...
FT_TEST(test_big_number_errno_resets_accessors)
{
...
FT_TEST(test_big_number_errno_resets_arithmetic)
{
    ft_big_number left_number;
    ft_big_number right_number;
...
FT_TEST(test_big_number_errno_resets_hex_helpers)
{
