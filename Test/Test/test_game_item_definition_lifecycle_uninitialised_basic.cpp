...
FT_TEST(test_game_item_definition_get_item_id_uninitialised_aborts)
{
...
FT_TEST(test_game_item_definition_set_item_id_uninitialised_aborts)
{
    FT_ASSERT_EQ(1, expect_game_lifecycle_sigabrt<game_item_definition>(
...
FT_TEST(test_game_item_definition_get_rarity_uninitialised_aborts)
{
    FT_ASSERT_EQ(1, expect_game_lifecycle_sigabrt<game_item_definition>(
...
FT_TEST(test_game_item_definition_set_rarity_uninitialised_aborts)
{
    FT_ASSERT_EQ(1, expect_game_lifecycle_sigabrt<game_item_definition>(
...
FT_TEST(test_game_item_definition_get_max_stack_uninitialised_aborts)
{
    FT_ASSERT_EQ(1, expect_game_lifecycle_sigabrt<game_item_definition>(
...
FT_TEST(test_game_item_definition_set_max_stack_uninitialised_aborts)
{
    FT_ASSERT_EQ(1, expect_game_lifecycle_sigabrt<game_item_definition>(
...
FT_TEST(test_game_item_definition_get_width_uninitialised_aborts)
{
    FT_ASSERT_EQ(1, expect_game_lifecycle_sigabrt<game_item_definition>(
...
FT_TEST(test_game_item_definition_set_width_uninitialised_aborts)
{
    FT_ASSERT_EQ(1, expect_game_lifecycle_sigabrt<game_item_definition>(
...
FT_TEST(test_game_item_definition_get_height_uninitialised_aborts)
{
    FT_ASSERT_EQ(1, expect_game_lifecycle_sigabrt<game_item_definition>(
...
FT_TEST(test_game_item_definition_set_height_uninitialised_aborts)
{
    FT_ASSERT_EQ(1, expect_game_lifecycle_sigabrt<game_item_definition>(
...
FT_TEST(test_game_item_definition_get_weight_uninitialised_aborts)
{
    FT_ASSERT_EQ(1, expect_game_lifecycle_sigabrt<game_item_definition>(
...
FT_TEST(test_game_item_definition_set_weight_uninitialised_aborts)
{
    FT_ASSERT_EQ(1, expect_game_lifecycle_sigabrt<game_item_definition>(
