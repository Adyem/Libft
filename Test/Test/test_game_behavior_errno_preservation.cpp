...
FT_TEST(test_behavior_action_default_construction_preserves_success,
    "default constructed behavior action reports zeros and success")
{
...
FT_TEST(test_behavior_action_parameterized_construction_sets_fields,
    "parameterized behavior action sets identifiers, weight, and cooldown")
{
...
FT_TEST(test_behavior_action_set_action_id_preserves_errno,
    "set_action_id leaves incoming ft_errno untouched")
{
    ft_behavior_action action;
...
FT_TEST(test_behavior_action_set_weight_preserves_errno,
    "set_weight leaves incoming ft_errno untouched")
{
    ft_behavior_action action;
...
FT_TEST(test_behavior_action_set_cooldown_preserves_errno,
    "set_cooldown_seconds leaves incoming ft_errno untouched")
{
    ft_behavior_action action;
...
FT_TEST(test_behavior_action_get_action_id_preserves_errno,
    "get_action_id restores entry errno while returning stored value")
{
...
FT_TEST(test_behavior_action_get_weight_preserves_errno,
    "get_weight restores entry errno while returning stored value")
{
...
FT_TEST(test_behavior_action_get_cooldown_preserves_errno,
    "get_cooldown_seconds restores entry errno while returning stored value")
{
...
FT_TEST(test_behavior_action_move_assignment_preserves_errno,
    "move assignment transfers values, clears source, and restores errno")
{
...
FT_TEST(test_behavior_profile_default_construction_preserves_success,
    "default constructed behavior profile starts empty and successful")
{
...
FT_TEST(test_behavior_profile_parameterized_construction_sets_fields,
    "parameterized behavior profile stores identifiers, weights, and actions")
{
...
FT_TEST(test_behavior_profile_set_profile_id_preserves_errno,
    "set_profile_id leaves incoming ft_errno untouched")
{
    ft_behavior_profile profile;
...
FT_TEST(test_behavior_profile_set_aggression_preserves_errno,
    "set_aggression_weight leaves incoming ft_errno untouched")
{
    ft_behavior_profile profile;
...
FT_TEST(test_behavior_profile_set_caution_preserves_errno,
    "set_caution_weight leaves incoming ft_errno untouched")
{
    ft_behavior_profile profile;
...
FT_TEST(test_behavior_profile_set_actions_preserves_errno_and_copies,
    "set_actions copies provided actions and restores entry errno")
{
    ft_behavior_profile profile;
    ft_vector<ft_behavior_action> actions;
...
FT_TEST(test_behavior_profile_copy_assignment_preserves_errno,
    "copy assignment clones profile values and restores entry errno")
{
    ft_vector<ft_behavior_action> actions;
...
FT_TEST(test_behavior_profile_move_assignment_preserves_errno,
    "move assignment transfers data, resets source, and restores errno")
{
    ft_vector<ft_behavior_action> actions;
    ft_behavior_profile source;
    ft_behavior_profile destination;
