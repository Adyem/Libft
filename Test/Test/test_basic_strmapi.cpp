...
FT_TEST(test_basic_strmapi_basic)
{
    char *result;
...
FT_TEST(test_basic_strmapi_uses_index_values)
{
    char *result;
...
FT_TEST(test_basic_strmapi_null_arguments_set_errno)
{
    FT_ASSERT_EQ(ft_nullptr, ft_strmapi(ft_nullptr, to_upper_map));
...
FT_TEST(test_basic_strmapi_success_after_failure_resets_errno)
{
    char *result;
...
FT_TEST(test_basic_strmapi_allocates_new_buffer)
{
    const char *source;
    char *result;
