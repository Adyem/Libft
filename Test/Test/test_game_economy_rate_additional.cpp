...
FT_TEST(test_currency_rate_default_constructor_values)
{
...
FT_TEST(test_currency_rate_initialize_copy_clones_values)
{
...
FT_TEST(test_currency_rate_initialize_overwrites_destination)
{
...
FT_TEST(test_currency_rate_setters_update_values)
{
    game_currency_rate rate;
