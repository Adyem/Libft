...
FT_TEST(test_dialogue_table_move_semantics, "dialogue table move constructor and assignment")
{
    ...
    FT_ASSERT_EQ(ER_SUCCESS, moved.fetch_script(9, script));
    ...
    FT_ASSERT_EQ(ER_SUCCESS, moved_assigned.fetch_script(9, script));
