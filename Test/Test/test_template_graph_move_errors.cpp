        ...
        "ft_graph move constructor clears source error and keeps graph usable")
{
    ...
    FT_ASSERT_EQ(FT_ERR_SUCCESSS, moved_graph.get_error());
    FT_ASSERT_EQ(FT_ERR_SUCCESSS, source_graph.get_error());
        ...
        "ft_graph move assignment clears source error and allows reuse")
{
    ...
    FT_ASSERT_EQ(FT_ERR_SUCCESSS, destination_graph.get_error());
    FT_ASSERT_EQ(FT_ERR_SUCCESSS, source_graph.get_error());
