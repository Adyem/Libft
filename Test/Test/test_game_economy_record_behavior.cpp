...
FT_TEST(test_price_definition_default_state)
{
...
FT_TEST(test_price_definition_initialize_with_fields)
{
    game_price_definition definition;
...
FT_TEST(test_price_definition_setters_update_all_fields)
{
    game_price_definition definition;
...
FT_TEST(test_price_definition_initialize_copy_matches_source)
{
    game_price_definition original;
    game_price_definition dest;
...
FT_TEST(test_currency_rate_default_state)
{
...
FT_TEST(test_currency_rate_initialize_with_fields_values)
{
    game_currency_rate rate;
...
FT_TEST(test_currency_rate_setters_update_fields)
{
    game_currency_rate rate;
...
FT_TEST(test_currency_rate_initialize_copy_overwrites_state)
{
    game_currency_rate source;
    game_currency_rate target;
