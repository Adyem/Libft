...
FT_TEST(test_basic_striteri_basic)
{
    char buffer[4];
...
FT_TEST(test_basic_striteri_respects_terminator)
{
    char buffer[6];
...
FT_TEST(test_basic_striteri_null_inputs)
{
    char buffer[5];
    char snapshot[5];
...
FT_TEST(test_basic_striteri_empty_string)
{
    char buffer[1];
