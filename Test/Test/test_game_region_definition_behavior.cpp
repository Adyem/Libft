...
FT_TEST(test_game_region_definition_parameterized_constructor_records_fields, "Region definition constructor stores provided values")
{
    ft_region_definition region(9, ft_string("canyon"), ft_string("rocky pass"), 14);
...
{
    ft_region_definition source(7, ft_string("reef"), ft_string("shallow waters"), 6);
