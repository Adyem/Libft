...
FT_TEST(test_game_dialogue_line_property_updates)
{
...
FT_TEST(test_game_dialogue_script_line_management)
{
    ft_vector<int> next_ids;
    ...
    const ft_vector<ft_sharedptr<game_dialogue_line>> &script_lines = script.get_lines();
