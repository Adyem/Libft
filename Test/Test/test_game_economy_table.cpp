...
FT_TEST(test_economy_register_and_fetch_price, "register and fetch price definition")
{
    ...
    FT_ASSERT_EQ(ER_SUCCESS, table.fetch_price_definition(10, fetched));
...
FT_TEST(test_economy_rarity_band_registration, "register and fetch rarity band")
{
    ...
    FT_ASSERT_EQ(ER_SUCCESS, table.fetch_rarity_band(4, fetched));
...
FT_TEST(test_economy_vendor_and_currency_profiles, "register vendor and currency profiles")
{
    ...
    FT_ASSERT_EQ(ER_SUCCESS, table.register_currency_rate(currency));
    FT_ASSERT_EQ(ER_SUCCESS, table.fetch_vendor_profile(2, fetched_vendor));
    FT_ASSERT_EQ(ER_SUCCESS, table.fetch_currency_rate(1, fetched_currency));
