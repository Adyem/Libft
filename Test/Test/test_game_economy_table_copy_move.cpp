...
static int register_all_records(ft_economy_table &table)
{
    ...
    FT_ASSERT_EQ(FT_ERR_SUCCESSS, table.register_currency_rate(rate));
    return (1);
}
...
FT_TEST(test_economy_table_copy_constructor, "copy constructor duplicates records and error state")
{
    ...
    FT_ASSERT_EQ(FT_ERR_SUCCESSS, copy.fetch_price_definition(4, price));
    FT_ASSERT_EQ(FT_ERR_SUCCESSS, copy.fetch_rarity_band(7, rarity));
    FT_ASSERT_EQ(FT_ERR_SUCCESSS, copy.fetch_vendor_profile(11, vendor));
    FT_ASSERT_EQ(FT_ERR_SUCCESSS, copy.fetch_currency_rate(5, currency));
...
FT_TEST(test_economy_table_copy_assignment, "copy assignment replaces state and error code")
{
    ...
    FT_ASSERT_EQ(FT_ERR_SUCCESSS, destination.fetch_price_definition(4, price));
    FT_ASSERT_EQ(FT_ERR_SUCCESSS, destination.fetch_rarity_band(7, rarity));
    FT_ASSERT_EQ(FT_ERR_SUCCESSS, destination.fetch_vendor_profile(11, vendor));
    FT_ASSERT_EQ(FT_ERR_SUCCESSS, destination.fetch_currency_rate(5, currency));
...
FT_TEST(test_economy_table_move_semantics, "move constructor and assignment transfer state")
{
    ...
    FT_ASSERT_EQ(FT_ERR_SUCCESSS, moved.fetch_price_definition(4, price));
    FT_ASSERT_EQ(FT_ERR_SUCCESSS, moved.fetch_rarity_band(7, rarity));
    FT_ASSERT_EQ(FT_ERR_SUCCESSS, moved.fetch_vendor_profile(11, vendor));
    FT_ASSERT_EQ(FT_ERR_SUCCESSS, moved.fetch_currency_rate(5, currency));
    ...
    FT_ASSERT_EQ(FT_ERR_SUCCESSS, reassigned.fetch_price_definition(4, price));
