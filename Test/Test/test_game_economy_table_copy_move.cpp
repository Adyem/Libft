...
FT_TEST(test_economy_table_copy_constructor, "copy constructor duplicates records and error state")
{
    ...
    FT_ASSERT_EQ(FT_ERR_SUCCESS, copy.fetch_price_definition(4, price));
    FT_ASSERT_EQ(FT_ERR_SUCCESS, copy.fetch_rarity_band(7, rarity));
    FT_ASSERT_EQ(FT_ERR_SUCCESS, copy.fetch_vendor_profile(11, vendor));
    FT_ASSERT_EQ(FT_ERR_SUCCESS, copy.fetch_currency_rate(5, currency));
...
FT_TEST(test_economy_table_move_semantics, "move constructor and assignment transfer state")
{
    ...
    FT_ASSERT_EQ(FT_ERR_SUCCESS, reassigned.fetch_price_definition(4, price));
