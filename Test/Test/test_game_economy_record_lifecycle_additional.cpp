...
static void price_get_item_id(game_price_definition &definition)
{
  (void)definition.get_item_id();
  return ;
}
static void price_get_rarity(game_price_definition &definition)
{
  (void)definition.get_rarity();
  return ;
}
static void price_get_base_value(game_price_definition &definition)
{
  (void)definition.get_base_value();
  return ;
}
static void price_set_item_id(game_price_definition &definition)
{
  definition.set_item_id(10);
  return ;
}
static void price_set_rarity(game_price_definition &definition)
{
  definition.set_rarity(3);
  return ;
}

static void rarity_get_rarity(game_rarity_band &band)
{
  (void)band.get_rarity();
  return ;
}
static void rarity_get_value_multiplier(game_rarity_band &band)
{
  (void)band.get_value_multiplier();
  return ;
}
static void rarity_set_rarity(game_rarity_band &band)
{
  band.set_rarity(2);
  return ;
}
static void rarity_set_value_multiplier(game_rarity_band &band)
{
  band.set_value_multiplier(1.5);
  return ;
}
static void rarity_is_thread_safe(game_rarity_band &band)
{
  (void)band.is_thread_safe();
  return ;
}

static void vendor_get_vendor_id(game_vendor_profile &profile)
{
  (void)profile.get_vendor_id();
  return ;
}
static void vendor_get_buy_markup(game_vendor_profile &profile)
{
  (void)profile.get_buy_markup();
  return ;
}
static void vendor_set_vendor_id(game_vendor_profile &profile)
{
  profile.set_vendor_id(4);
  return ;
}
static void vendor_set_buy_markup(game_vendor_profile &profile)
{
  profile.set_buy_markup(1.2);
  return ;
}
static void vendor_enable_thread_safety(game_vendor_profile &profile)
{
  (void)profile.enable_thread_safety();
  return ;
}

static void currency_get_currency_id(game_currency_rate &rate)
{
  (void)rate.get_currency_id();
  return ;
}
static void currency_get_rate_to_base(game_currency_rate &rate)
{
  (void)rate.get_rate_to_base();
  return ;
}
static void currency_get_display_precision(game_currency_rate &rate)
{
  (void)rate.get_display_precision();
  return ;
}
static void currency_set_currency_id(game_currency_rate &rate)
{
  rate.set_currency_id(5);
  return ;
}
static void currency_set_rate_to_base(game_currency_rate &rate)
{
  rate.set_rate_to_base(2.0);
  return ;
}
...
{
  FT_ASSERT_EQ(
      1, expect_sigabrt_on_uninitialised_object(rarity_get_value_multiplier));
  return (1);
}
...
{
  FT_ASSERT_EQ(
      1, expect_sigabrt_on_uninitialised_object(rarity_set_value_multiplier));
  return (1);
}
...
{
  FT_ASSERT_EQ(0,
               expect_sigabrt_on_uninitialised_object(rarity_is_thread_safe));
  return (1);
}
...
{
  FT_ASSERT_EQ(1,
               expect_sigabrt_on_uninitialised_object(vendor_get_buy_markup));
  return (1);
}
...
{
  FT_ASSERT_EQ(1,
               expect_sigabrt_on_uninitialised_object(vendor_set_buy_markup));
  return (1);
}
...
{
  FT_ASSERT_EQ(
      1, expect_sigabrt_on_uninitialised_object(vendor_enable_thread_safety));
  return (1);
}
...
{
  FT_ASSERT_EQ(
      1, expect_sigabrt_on_uninitialised_object(currency_get_currency_id));
  return (1);
}
...
{
  FT_ASSERT_EQ(
      1, expect_sigabrt_on_uninitialised_object(currency_get_rate_to_base));
  return (1);
}

FT_TEST(test_currency_lifecycle_get_display_precision_uninitialised_aborts)
{
  FT_ASSERT_EQ(1, expect_sigabrt_on_uninitialised_object(
                      currency_get_display_precision));
  return (1);
}
...
{
  FT_ASSERT_EQ(
      1, expect_sigabrt_on_uninitialised_object(currency_set_currency_id));
  return (1);
}
...
{
  FT_ASSERT_EQ(
      1, expect_sigabrt_on_uninitialised_object(currency_set_rate_to_base));
  return (1);
}
