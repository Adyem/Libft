...
FT_TEST(test_currency_rate_default_initialization_values)
{
...
FT_TEST(test_currency_rate_initialize_copy_resets_destination)
{
...
FT_TEST(test_currency_rate_setters_apply_values)
{
    game_currency_rate rate;
...
FT_TEST(test_price_definition_default_values)
{
...
FT_TEST(test_price_definition_initialize_with_fields_values)
{
    game_price_definition definition;
...
FT_TEST(test_price_definition_setters_apply_updates)
{
    game_price_definition definition;
