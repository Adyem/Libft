...
FT_TEST(test_price_definition_setters_update_values)
{
...
FT_TEST(test_rarity_band_setters_refresh_multiplier)
{
...
FT_TEST(test_currency_rate_setters_apply_changes)
{
...
FT_TEST(test_goal_progress_accumulates_through_setters)
{
    game_goal goal;
...
FT_TEST(test_reputation_current_and_total_tracking)
{
