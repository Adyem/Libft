...
COMPILE_FLAGS := -Wall -Wextra -Werror -std=c++17 $(OPT_FLAGS) -pthread -Wno-missing-declarations -DLIBFT_TEST_BUILD -DLIBFT_INTERNAL_HEADERS
ifneq ($(UNAME_S),Darwin)
COMPILE_FLAGS += -Wuseless-cast -fcf-protection=none
endif
...
LDFLAGS := -Wl,--allow-multiple-definition -rdynamic -lz -ldl $(OPENSSL_LIBS) $(SQLITE_LIBS) $(X11_LIBS) $(XEXT_LIBS) $(ASOUND_LIBS)
endif
