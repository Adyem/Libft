...
ft_trie<ValueType>::ft_trie()
        : _data(ft_nullptr), _children(), _error_code(FT_ER_SUCCESSS),
        _last_error(FT_ER_SUCCESSS), _state_mutex(ft_nullptr), _thread_safe_enabled(false)
{
