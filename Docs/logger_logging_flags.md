...
[`Logger/logger.hpp`](../Modules/Logger/logger.hpp):
...
- [`cma_malloc`](../Modules/CMA/cma_malloc.cpp) – records the caller's size request and
...
- [`cma_aligned_alloc`](../Modules/CMA/cma_aligned_alloc.cpp) – captures alignment
...
- [`cma_free`](../Modules/CMA/cma_free.cpp) – announces the pointer being released so
