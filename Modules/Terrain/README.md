...
The `Terrain` module is compiled when `GAME_USE_VOXEL_REGION_BACKEND` is enabled. It generates biome-aware voxel terrain with seeded heightmaps and builds renderable chunk meshes from voxel data.
