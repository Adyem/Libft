...
static const t_ft_error_string g_error_strings[] =
{
    ...
    {FT_ERR_BUSY, "Resource busy"},
    {FT_ERR_NOT_IMPLEMENTED, "Operation not implemented"},
    {FT_ERR_CLOSED, "Resource is closed"},
    {FT_ERR_TOO_LARGE, "Value too large"},
    {FT_ERR_INTERRUPTED, "Operation interrupted"},
    {FT_ERR_OVERFLOW, "Overflow detected"},
    {FT_ERR_EXISTING_DATA, "Existing data present"},
